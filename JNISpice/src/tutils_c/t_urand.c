...
/* -    Testutil Version 1.1.0, 09-JUN-2010 (NJB) */

/*        Bug fix: K is now reset properly prior to the */
/*        second linear congruential step. */
...
/*           by Schrage's method. */
		...
		iv[(i__1 = j - 1) < 32 && 0 <= i__1 ? i__1 : s_rnge("iv", 
			i__1, "t_urand__", (ftnlen)265)] = idum;
	    }
	}
	iy = iv[0];
    }
