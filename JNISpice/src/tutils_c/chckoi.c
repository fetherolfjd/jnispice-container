/* chckoi.f -- translated by f2c (version 19980913).
...
/* Subroutine */ int chckoi_(char *name__, integer *array, char *order, 
...
/*     Check the order of elements of an integer array. */
...
/*     So far the test case has not failed. */
	...
	repmi_(messge, "$", &i__1, messge, (ftnlen)240, (ftnlen)1, (ftnlen)
		240);
	repmi_(messge, "%", &array[j - 1], messge, (ftnlen)240, (ftnlen)1, (
		ftnlen)240);
	repmi_(messge, "&", &array[j], messge, (ftnlen)240, (ftnlen)1, (
		ftnlen)240);
