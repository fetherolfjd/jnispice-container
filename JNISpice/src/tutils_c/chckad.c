...
/* -    Testing Utility Version 1.3.0, 23-APR-2014 (BVS)(NJB) */
...
/* -    Testing Utility Version 1.2.0, 20-OCT-2006 (EDW) */

/*        Corrected logic error in the ~~/ test block. Replaced the */
/*        line */
...
/*           IF ( (SIZE1 .EQ. 0.D0 ) .AND. (SIZE2 .EQ. 0.D0) ) THEN */
...
/*     Set placeholder message. */
    ...
    s_copy(messge, "This is a placeholder message that should have never bee"
	    "n displayed. It indicates a CHCKAD bug.", (ftnlen)800, (ftnlen)95)
	    ;
    fail = FALSE_;
...
/*        are NaN. */
	...
	valnan = ! (array[i__ - 1] > 1.) && ! (array[i__ - 1] < 1.) && ! (
		array[i__ - 1] == 1.);
	expnan = ! (exp__[i__ - 1] > 1.) && ! (exp__[i__ - 1] < 1.) && ! (
		exp__[i__ - 1] == 1.);
	if (valnan || expnan) {
...
/*              Only EXP(I) is NaN. */
		...
		s_copy(messge, "The value # of array # was #. The expected v"
			"alue was NaN.", (ftnlen)800, (ftnlen)57);
...
/*              Only ARRAY(I) is NaN. */
		...
		s_copy(messge, "The value # of array # was NaN. The expected"
			" value was #.", (ftnlen)800, (ftnlen)57);
		repmi_(messge, "#", &i__, messge, (ftnlen)800, (ftnlen)1, (
			ftnlen)800);
		repmc_(messge, "#", name__, messge, (ftnlen)800, (ftnlen)1, 
			rtrim_(name__, name_len), (ftnlen)800);
		...
		s_copy(messge, "The value # of array # and the expected valu"
			"e were NaN.", (ftnlen)800, (ftnlen)55);
		repmi_(messge, "#", &i__, messge, (ftnlen)800, (ftnlen)1, (
			ftnlen)800);
		repmc_(messge, "#", name__, messge, (ftnlen)800, (ftnlen)1, 
			rtrim_(name__, name_len), (ftnlen)800);
...
/* Computing MAX */
	...
	fail = angle > *tol;
	if (fail) {
	    s_copy(messge, "The \"angle\" between direction of the #-vector "
		    "# and the expected direction was #./cr/cr The maximum al"
		    "lowed angle for a successful test is #. ", (ftnlen)800, (
		    ftnlen)142);
	    repmi_(messge, "#", size, messge, (ftnlen)800, (ftnlen)1, (ftnlen)
		    800);
	    repmc_(messge, "#", name__, messge, (ftnlen)800, (ftnlen)1, 
		    rtrim_(name__, name_len), (ftnlen)800);
	    repmd_(messge, "#", &angle, &c__14, messge, (ftnlen)800, (ftnlen)
		    1, (ftnlen)800);
	...
	fail = howfar > *tol;
	if (fail) {
	    s_copy(messge, "The \"distance\" between  the #-vector # and the"
		    " expected vector was #./cr/cr  The maximum allowed dista"
		    "nce for a successful test is #. ", (ftnlen)800, (ftnlen)
		    134);
	    repmi_(messge, "#", size, messge, (ftnlen)800, (ftnlen)1, (ftnlen)
		    800);
	    repmc_(messge, "#", name__, messge, (ftnlen)800, (ftnlen)1, 
		    rtrim_(name__, name_len), (ftnlen)800);
	    repmd_(messge, "#", &howfar, &c__14, messge, (ftnlen)800, (ftnlen)
		    1, (ftnlen)800);
	    repmd_(messge, "#", tol, &c__14, messge, (ftnlen)800, (ftnlen)1, (
		    ftnlen)800);
	}
	...
	fail = rel > *tol;
	if (fail) {
	    s_copy(messge, "The vector relative difference between the #-vec"
		    "tor # and the expected vector was #./cr/cr The maximum a"
		    "llowed relative difference for a successful test is #. ", 
		    (ftnlen)800, (ftnlen)159);
	    repmi_(messge, "#", size, messge, (ftnlen)800, (ftnlen)1, (ftnlen)
		    800);
	    repmc_(messge, "#", name__, messge, (ftnlen)800, (ftnlen)1, 
		    rtrim_(name__, name_len), (ftnlen)800);
	...
	if (fail) {
	    s_copy(messge, "The \"angle\" between direction of the #-vector "
		    "# and the expected direction was # radians away from bei"
		    "ng pi/2./cr/cr The maximum allowed defect in angle allow"
		    "ed for a successful test is #. ", (ftnlen)800, (ftnlen)
		    189);
	    repmi_(messge, "#", size, messge, (ftnlen)800, (ftnlen)1, (ftnlen)
		    800);
	    repmc_(messge, "#", name__, messge, (ftnlen)800, (ftnlen)1, 
		    rtrim_(name__, name_len), (ftnlen)800);
	    repmd_(messge, "#", &defect, &c__14, messge, (ftnlen)800, (ftnlen)
		    1, (ftnlen)800);
	    repmd_(messge, "#", tol, &c__14, messge, (ftnlen)800, (ftnlen)1, (
		    ftnlen)800);
	}
    ...
    if (! fail) {
	if (verbos_()) {
	    s_copy(messge, "The comparison /cr/cr(3:)'# # EXPECTED' /cr/cr(-"
		    "3:) was satisfied to the specified tolerance: #.", (
		    ftnlen)800, (ftnlen)96);
	    repmc_(messge, "#", name__, messge, (ftnlen)800, (ftnlen)1, 
		    rtrim_(name__, name_len), (ftnlen)800);
	    repmc_(messge, "#", comp, messge, (ftnlen)800, (ftnlen)1, rtrim_(
		    comp, comp_len), (ftnlen)800);
	    repmd_(messge, "#", tol, &c__14, messge, (ftnlen)800, (ftnlen)1, (
		    ftnlen)800);
	    tstlog_(" ", &fail, (ftnlen)1);
	    tstlog_(messge, &fail, (ftnlen)800);
