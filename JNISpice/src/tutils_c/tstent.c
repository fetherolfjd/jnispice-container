	...
	isnull, ftnlen table_len, ftnlen column_len, ftnlen cvals_len)
{
    ...
    /* Local variables */
    static integer dims__[100], i__, j, r__;
    ...
    static integer cclass[100], basval;
    extern integer isrchc_(char *, integer *, char *, ftnlen, ftnlen);
    static logical indexd[100];
    static integer colidx;
    extern /* Subroutine */ int sigerr_(char *, ftnlen), chkout_(char *, 
	    ftnlen), setmsg_(char *, ftnlen);
    static logical nullok[100];
    static integer dtypes[100], stlens[100];
...
/* -    Testing Utilities Version 1.1.0, 23-DEC-2009 (EDW) */

/*        Save declaration altered to save all variables. */
...
/*     declared column string length. */
    ...
    if (dtypes[(i__1 = colidx - 1) < 100 && 0 <= i__1 ? i__1 : s_rnge("dtypes"
	    , i__1, "tstent_", (ftnlen)1222)] == 1) {
	r__ = stlens[(i__1 = colidx - 1) < 100 && 0 <= i__1 ? i__1 : s_rnge(
		"stlens", i__1, "tstent_", (ftnlen)1224)];
	if (r__ == -1) {
