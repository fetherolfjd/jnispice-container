/* zztstek.f -- translated by f2c (version 19980913).
...
/* $Procedure ZZTSTEK ( Private --- produce an EK for testing ) */
/* Subroutine */ int zztstek_(char *file, integer *fileno, integer *mxrows, 
	ftnlen file_len)
{
    /* Initialized data */
    ...
    extern /* Subroutine */ int ekffld_(integer *, integer *, integer *), 
    ...
    extern /* Subroutine */ int tstent_(integer *, char *, integer *, char *, 
	    ...
	    doublereal *, logical *, ftnlen, ftnlen, ftnlen);
    static integer loc;
...
/* -   TESTUTIL Version 1.0.0,  16-FEB-2010 (EDW) */

/*       Reimplementation of TSTEK, removing arguments and code */
/*       to load created file and register with the test subsystem. */
...
/*        Look up the schema for this table. */
	...
	tstsch_(tables + (((i__1 = tabno - 1) < 6 && 0 <= i__1 ? i__1 : 
		s_rnge("tables", i__1, "zztstek_", (ftnlen)409)) << 6), 
		mxrows, &segtyp, &nrows, &ncols, cnames, cclass, dtypes, 
		stlens, dims__, indexd, nullok, decls, (ftnlen)64, (ftnlen)32,
		 (ftnlen)200);
...
/*        Initiate a fast load. */
	...
	ekifld_(&handle, tables + (((i__1 = tabno - 1) < 6 && 0 <= i__1 ? 
		i__1 : s_rnge("tables", i__1, "zztstek_", (ftnlen)455)) << 6),
...
/*           slot. */
		...
		if (stlens[(i__3 = colno - 1) < 100 && 0 <= i__3 ? i__3 : 
			s_rnge("stlens", i__3, "zztstek_", (ftnlen)472)] > 
			100) {
...
/*                 the fat string buffer. */
		    ...
		    tstent_(fileno, tables + (((i__3 = tabno - 1) < 6 && 0 <= 
			    i__3 ? i__3 : s_rnge("tables", i__3, "zztstek_", (
			    ftnlen)477)) << 6), &segno, cnames + (((i__4 = 
			    colno - 1) < 100 && 0 <= i__4 ? i__4 : s_rnge(
			    "cnames", i__4, "zztstek_", (ftnlen)477)) << 5), &
			    i__, &c__20, &entszs[(i__5 = i__ - 1) < 5000 && 0 
			    <= i__5 ? i__5 : s_rnge("entszs", i__5, "zztstek_"
			    , (ftnlen)477)], fatbuf + (((i__6 = p - 1) < 2000 
			    && 0 <= i__6 ? i__6 : s_rnge("fatbuf", i__6, 
			    "zztstek_", (ftnlen)477)) << 10), &dvals[(i__7 = 
			    p - 1) < 50000 && 0 <= i__7 ? i__7 : s_rnge("dva"
			    "ls", i__7, "zztstek_", (ftnlen)477)], &ivals[(
			    i__8 = p - 1) < 50000 && 0 <= i__8 ? i__8 : 
			    s_rnge("ivals", i__8, "zztstek_", (ftnlen)477)], &
			    tvals[(i__9 = p - 1) < 50000 && 0 <= i__9 ? i__9 :
			     s_rnge("tvals", i__9, "zztstek_", (ftnlen)477)], 
			    &nlflgs[(i__10 = i__ - 1) < 5000 && 0 <= i__10 ? 
			    i__10 : s_rnge("nlflgs", i__10, "zztstek_", (
			    ftnlen)477)], (ftnlen)64, (ftnlen)32, (ftnlen)
			    1024);
		} else {
...
/*                 Use the normal buffers. */
		    ...
		    tstent_(fileno, tables + (((i__3 = tabno - 1) < 6 && 0 <= 
			    i__3 ? i__3 : s_rnge("tables", i__3, "zztstek_", (
			    ftnlen)486)) << 6), &segno, cnames + (((i__4 = 
			    colno - 1) < 100 && 0 <= i__4 ? i__4 : s_rnge(
			    "cnames", i__4, "zztstek_", (ftnlen)486)) << 5), &
			    i__, &c__20, &entszs[(i__5 = i__ - 1) < 5000 && 0 
			    <= i__5 ? i__5 : s_rnge("entszs", i__5, "zztstek_"
			    , (ftnlen)486)], cvals + ((i__6 = p - 1) < 50000 
			    && 0 <= i__6 ? i__6 : s_rnge("cvals", i__6, "zzt"
			    "stek_", (ftnlen)486)) * 100, &dvals[(i__7 = p - 1)
			     < 50000 && 0 <= i__7 ? i__7 : s_rnge("dvals", 
			    i__7, "zztstek_", (ftnlen)486)], &ivals[(i__8 = p 
			    - 1) < 50000 && 0 <= i__8 ? i__8 : s_rnge("ivals",
			     i__8, "zztstek_", (ftnlen)486)], &tvals[(i__9 = 
			    p - 1) < 50000 && 0 <= i__9 ? i__9 : s_rnge("tva"
			    "ls", i__9, "zztstek_", (ftnlen)486)], &nlflgs[(
			    i__10 = i__ - 1) < 5000 && 0 <= i__10 ? i__10 : 
			    s_rnge("nlflgs", i__10, "zztstek_", (ftnlen)486)],
			     (ftnlen)64, (ftnlen)32, (ftnlen)100);
		}
...
/*              the current entry. */
		...
		p += entszs[(i__3 = i__ - 1) < 5000 && 0 <= i__3 ? i__3 : 
			s_rnge("entszs", i__3, "zztstek_", (ftnlen)496)];
	    }
...
/*           routine based on the column's data type. */
	    ...
	    if (dtypes[(i__2 = colno - 1) < 100 && 0 <= i__2 ? i__2 : s_rnge(
		    "dtypes", i__2, "zztstek_", (ftnlen)504)] == 1) {
		if (stlens[(i__2 = colno - 1) < 100 && 0 <= i__2 ? i__2 : 
			s_rnge("stlens", i__2, "zztstek_", (ftnlen)507)] > 
			100) {
		    ekaclc_(&handle, &segno, cnames + (((i__2 = colno - 1) < 
			    100 && 0 <= i__2 ? i__2 : s_rnge("cnames", i__2, 
			    "zztstek_", (ftnlen)509)) << 5), fatbuf, entszs, 
			    nlflgs, rcptrs, wkindx, (ftnlen)32, (ftnlen)1024);
		} else {
		    ekaclc_(&handle, &segno, cnames + (((i__2 = colno - 1) < 
			    100 && 0 <= i__2 ? i__2 : s_rnge("cnames", i__2, 
			    "zztstek_", (ftnlen)514)) << 5), cvals, entszs, 
			    nlflgs, rcptrs, wkindx, (ftnlen)32, (ftnlen)100);
		}
	    } else if (dtypes[(i__2 = colno - 1) < 100 && 0 <= i__2 ? i__2 : 
		    s_rnge("dtypes", i__2, "zztstek_", (ftnlen)519)] == 2) {
		ekacld_(&handle, &segno, cnames + (((i__2 = colno - 1) < 100 
			&& 0 <= i__2 ? i__2 : s_rnge("cnames", i__2, "zztste"
			"k_", (ftnlen)521)) << 5), dvals, entszs, nlflgs, 
			rcptrs, wkindx, (ftnlen)32);
	    } else if (dtypes[(i__2 = colno - 1) < 100 && 0 <= i__2 ? i__2 : 
		    s_rnge("dtypes", i__2, "zztstek_", (ftnlen)524)] == 3) {
		ekacli_(&handle, &segno, cnames + (((i__2 = colno - 1) < 100 
			&& 0 <= i__2 ? i__2 : s_rnge("cnames", i__2, "zztste"
			"k_", (ftnlen)526)) << 5), ivals, entszs, nlflgs, 
			rcptrs, wkindx, (ftnlen)32);
	    } else {
...
/*              The data type is TIME.  Use the DP column add routine. */
		...
		ekacld_(&handle, &segno, cnames + (((i__2 = colno - 1) < 100 
			&& 0 <= i__2 ? i__2 : s_rnge("cnames", i__2, "zztste"
			"k_", (ftnlen)533)) << 5), tvals, entszs, nlflgs, 
			rcptrs, wkindx, (ftnlen)32);
	    }
	}
