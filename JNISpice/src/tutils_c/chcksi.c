...
/*     Set placeholder message. */
    ...
    s_copy(messge, "This is a placeholder message that should have never bee"
	    "n displayed. It indicates a CHCKSI bug.", (ftnlen)320, (ftnlen)95)
	    ;
    fail = FALSE_;
    if (s_cmp(comp, "=", comp_len, (ftnlen)1) == 0) {
	fail = *val != *exp__;
	if (fail) {
	    s_copy(messge, "The value of # was not the value expected. The v"
		    "alue was: # the expected value was #. ", (ftnlen)320, (
		    ftnlen)86);
	    repmc_(messge, "#", name__, messge, (ftnlen)320, (ftnlen)1, 
		    rtrim_(name__, name_len), (ftnlen)320);
	    repmi_(messge, "#", val, messge, (ftnlen)320, (ftnlen)1, (ftnlen)
		    320);
	    repmi_(messge, "#", exp__, messge, (ftnlen)320, (ftnlen)1, (
		    ftnlen)320);
	}
	...
	if (fail) {
	    s_copy(messge, "The value of # was not less than # as was expect"
		    "ed.  The value was #. ", (ftnlen)320, (ftnlen)70);
	    repmc_(messge, "#", name__, messge, (ftnlen)320, (ftnlen)1, 
		    rtrim_(name__, name_len), (ftnlen)320);
	    repmi_(messge, "#", exp__, messge, (ftnlen)320, (ftnlen)1, (
		    ftnlen)320);
	...
	if (fail) {
	    s_copy(messge, "The value of # was not greater than # as was exp"
		    "ected.  The value was #. ", (ftnlen)320, (ftnlen)73);
	    repmc_(messge, "#", name__, messge, (ftnlen)320, (ftnlen)1, 
		    rtrim_(name__, name_len), (ftnlen)320);
	    repmi_(messge, "#", exp__, messge, (ftnlen)320, (ftnlen)1, (
		    ftnlen)320);
	...
	if (fail) {
	    s_copy(messge, "The value of # should have been different from #"
		    ". It wasn't. ", (ftnlen)320, (ftnlen)61);
	    repmc_(messge, "#", name__, messge, (ftnlen)320, (ftnlen)1, 
		    rtrim_(name__, name_len), (ftnlen)320);
	    repmi_(messge, "#", exp__, messge, (ftnlen)320, (ftnlen)1, (
		    ftnlen)320);
	...
	if (fail) {
	    s_copy(messge, "The value of # was not within # of #.  The value"
		    " was # . The difference between the actual and expected "
		    "value was #. ", (ftnlen)320, (ftnlen)117);
	    repmc_(messge, "#", name__, messge, (ftnlen)320, (ftnlen)1, 
		    rtrim_(name__, name_len), (ftnlen)320);
	    repmi_(messge, "#", tol, messge, (ftnlen)320, (ftnlen)1, (ftnlen)
		    320);
	    repmi_(messge, "#", exp__, messge, (ftnlen)320, (ftnlen)1, (
		    ftnlen)320);
	    repmi_(messge, "#", val, messge, (ftnlen)320, (ftnlen)1, (ftnlen)
		    320);
	    i__1 = *val - *exp__;
	    repmi_(messge, "#", &i__1, messge, (ftnlen)320, (ftnlen)1, (
		    ftnlen)320);
	}
    } else {
	fail = TRUE_;
    ...
    if (! fail) {
	if (verbos_()) {
	    s_copy(messge, "The comparison '# # #' was satisfied. The value "
		    "of # was #. ", (ftnlen)320, (ftnlen)60);
	    repmc_(messge, "#", name__, messge, (ftnlen)320, (ftnlen)1, 
		    rtrim_(name__, name_len), (ftnlen)320);
