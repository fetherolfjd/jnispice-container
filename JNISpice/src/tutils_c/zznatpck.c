/* zznatpck.f -- translated by f2c (version 19980913).
...
/* Subroutine */ int zznatpck_(char *namepc, ftnlen namepc_len)
{
...
/*        Reimplementation of NATPCK removing all code */
...
/*     Create the PCK. */
	...
	writln_(pck + ((i__1 = i__ - 1) < 393 && 0 <= i__1 ? i__1 : s_rnge(
		"pck", i__1, "zznatpck_", (ftnlen)859)) * 80, &unit, (ftnlen)
		80);
    }
    cl__1.cerr = 0;
    cl__1.cunit = unit;
