...
-Procedure tstek_c ( Create an EK for testing )

-Abstract
 
   Create an EK file for testing the EK writing and reading routines.
...
-Version
   ...
   -tutils_c Version 1.2.0, 07-FEB-2017 (NJB)  

      Bug fix: this routine now casts arguments of fabs to 
      double, and casts the result as necessary.

      Added Index_Entries section and updated Procedure and Abstract
      sections.
...
{ /* Begin tstek_c */
   ...
   */
   ...
   #define MaxAbsInt(a,b)                                  \
                                                           \
      (  (SpiceInt)( MaxAbs( (double)(a), (double)(b) ) )  )
   ...
   */
   ...
   for ( tabno = 0;  tabno < NTABS;  tabno++ )
   {
      ...
      */
      ...
      for ( i = 0;  i < ncols;  i++ )
      {
         maxstl = MaxAbsInt ( maxstl, stlens[i] );
      }
