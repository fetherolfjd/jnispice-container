/* t_ilumin.f -- translated by f2c (version 19980913).
...
/* Subroutine */ int t_ilumin__(char *method, char *target, doublereal *et, 
	char *fixref, char *abcorr, char *obsrvr, doublereal *spoint, 
	doublereal *trgepc, doublereal *srfvec, doublereal *phase, doublereal 
	*solar, doublereal *emissn, ftnlen method_len, ftnlen target_len, 
	ftnlen fixref_len, ftnlen abcorr_len, ftnlen obsrvr_len)
{
    ...
    char locmth[80];
    doublereal normal[3], stloff[3], offsun[3], subvec[3];
    integer typeid;
    logical attblk[15];
    ...
    extern /* Subroutine */ int sigerr_(char *, ftnlen), namfrm_(char *, 
	    ...
	    doublereal *, ftnlen), pxform_(char *, char *, doublereal *, 
...
/*     This routine provides an illumination angle computation */
/*     independent of those performed in ILUMIN, GFILUM, and */
/*     ZZILUMSTA. */
...
/*         calling T_ILUMIN, the error will be diagnosed and signaled by */
/*         a routine in the call tree of this routine. Note that when */
...
/*         loaded into the kernel pool prior to calling T_ILUMIN, the */
/*         error will be diagnosed and signaled by a routine in the call */
/*         tree of this routine. */
...
/*         orientation have not been loaded prior to calling T_ILUMIN, */
...
/*     C */
/*           CALL T_ILUMIN ( 'Ellipsoid', TARGET, ET,     'IAU_MARS', */
...
/* -    Test Utility Version 1.0.0, 20-FEB-2012 (NJB) */

/* -       Based on BSPICELIB Version 1.1.0, 17-MAY-2010 (NJB) */
