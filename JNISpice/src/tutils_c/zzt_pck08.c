/* zzt_pck08.f -- translated by f2c (version 19980913).
...
/* $Procedure ZZT_PCK08 (Create a test text PCK based on pck00008.tpc ) */
/* Subroutine */ int zzt_pck08__(char *namepc, ftnlen namepc_len)
{
...
/*        Reimplementation of T_PCK08 removing all code */
...
/*     Create the PCK kernel. */
	...
	r__ = rtrim_(pck + ((i__1 = i__ - 1) < 2605 && 0 <= i__1 ? i__1 : 
		s_rnge("pck", i__1, "zzt_pck08__", (ftnlen)3802)) * 80, (
		ftnlen)80);
	writln_(pck + ((i__1 = i__ - 1) < 2605 && 0 <= i__1 ? i__1 : s_rnge(
		"pck", i__1, "zzt_pck08__", (ftnlen)3803)) * 80, &unit, r__);
    }
    cl__1.cerr = 0;
    cl__1.cunit = unit;
    cl__1.csta = 0;
